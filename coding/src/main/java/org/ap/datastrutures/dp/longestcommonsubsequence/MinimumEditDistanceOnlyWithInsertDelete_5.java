...
insertion = s2 - lcs
 */
class MinimumEditDistanceOnlyWithInsertDelete_5 {
    ...
    public static void main(String[] args) {
        MinimumEditDistanceOnlyWithInsertDelete_5 minimumEditDistanceWithInsertDelete = new MinimumEditDistanceOnlyWithInsertDelete_5();
        String s1 = "heap";
        String s2 = "pea";
