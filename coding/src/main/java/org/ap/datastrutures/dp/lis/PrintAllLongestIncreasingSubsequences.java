...
/*
LongestIncreasingSubsequence.JPG
each element try to be part of longest group where it is largest one
+
reverse engineering (BFS) - see from where longest is build and keep adding in queue
 */
