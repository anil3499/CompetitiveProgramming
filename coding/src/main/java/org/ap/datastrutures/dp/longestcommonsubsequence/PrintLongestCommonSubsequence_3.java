...
public class PrintLongestCommonSubsequence_3 {
    ...
    public static void main(String[] args) {
        PrintLongestCommonSubsequence_3 longestCommonSubsequenceUsingRecursion = new PrintLongestCommonSubsequence_3();
        String s1 = "abcdgh";
        String s2 = "abedfhr";
