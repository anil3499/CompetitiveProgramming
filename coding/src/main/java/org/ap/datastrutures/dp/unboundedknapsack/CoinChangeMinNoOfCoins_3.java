package org.ap.datastrutures.dp.unboundedknapsack;
 ...
 */
public class CoinChangeMinNoOfCoins_3 {
    ...
    public static void main(String[] args) {
        CoinChangeMinNoOfCoins_3 coinChangeMinNoOfCoins=new CoinChangeMinNoOfCoins_3();
