...
public class MinimumNoOfInsertionToConvertInPalindrom_10 {
    ...
    public static void main(String[] args) {
        MinimumNoOfInsertionToConvertInPalindrom_10 minimumNoOfInsertionToConvertInPalindrom = new MinimumNoOfInsertionToConvertInPalindrom_10();
        String s1 = "acbcbda";
