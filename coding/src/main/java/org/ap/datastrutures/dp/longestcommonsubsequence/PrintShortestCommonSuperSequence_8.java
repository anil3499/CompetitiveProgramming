...
public class PrintShortestCommonSuperSequence_8 {
    ...
    public static void main(String[] args) {
        PrintShortestCommonSuperSequence_8 printShortestCommonSuperSequence = new PrintShortestCommonSuperSequence_8();
        String s1 = "GEEK";
        String s2 = "EKE";
