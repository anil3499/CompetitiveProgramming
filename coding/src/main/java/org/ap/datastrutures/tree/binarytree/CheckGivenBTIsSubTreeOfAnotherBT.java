...
public class CheckGivenBTIsSubTreeOfAnotherBT {
    ...
    public static boolean checkSubtreeUsingRecursion(TreeNode<Integer> tree, TreeNode<Integer> subtree) {
        ...
        return checkSubtreeUsingRecursion(tree.left,subtree)
                || checkSubtreeUsingRecursion(tree.right,subtree);
    ...
    public static void main(String[] args)
    {
        ...
        if (checkSubtreeUsingRecursion(root, root.right)) {
            System.out.print("Yes");
        }
        else {
            System.out.print("No");
