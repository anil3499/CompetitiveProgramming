...
public class SpiralOrderTraversal {
    ...
    */
    ...
    public static void printSpiralOrderRecursion(TreeNode<Integer> root, int level, Map<Integer, Deque<Integer>> map){
        if (root == null) {
            return;
        }
        ...
        printSpiralOrderRecursion(root.left, level + 1, map);
        printSpiralOrderRecursion(root.right, level + 1, map);
    }

    public static void printSpiralOrderRecursion(TreeNode<Integer> root){
        Map<Integer, Deque<Integer>> map=new HashMap<>();
        printSpiralOrderRecursion(root,0,map);
