...
public class BottomViewOfBinaryTree_HD {

    private static void printBottomView(TreeNode<Integer> root, int level, int hdist, Map<Integer,Pair<Integer,Integer>> map) {
        if(root == null){
            return;
        }
    ...
    public static void printBottomViewRecursion(TreeNode<Integer> root) {
    ...
    public static void printBottomViewIterative(TreeNode<Integer> root){
