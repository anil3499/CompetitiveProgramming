...
public class LeftViewOfBinaryTree {
    ...
    private static void leftView(TreeNode<Integer> root, int level, Map<Integer,Integer> map){
        if(root == null){
            return;
        }
    ...
    public static void printLeftViewUsingRecursion(TreeNode<Integer> root) {
        Map<Integer,Integer> map=new HashMap<>();
        leftView(root,1,map);
        map.forEach((k,v)->System.out.print(v+" "));
    }

    public static void printLeftViewUsingIterative(TreeNode<Integer> root) {
