package org.ap.datastrutures.heap.heap;
/*
...
Mapping the elements of a heap into an array is trivial: if a node is stored an index k, then its left child is stored
