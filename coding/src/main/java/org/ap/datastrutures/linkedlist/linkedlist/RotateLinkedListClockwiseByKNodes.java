...
public class RotateLinkedListClockwiseByKNodes {
    ...
    private static LinkedListNode<Integer> rotateClockwseByK(LinkedListNode<Integer> head,int k) {
    ...
    public static void main(String[] args)
    {
        ...
        LinkedListNode<Integer> head = rotateClockwseByK(mll.head,k);
        System.out.println();
