...
public class FlattenLinkedList {
    ...
    public static LinkedListNode<Integer> flattenUsingPrioirityQueue(LinkedListNode<Integer> head){
    ...
    public static void main(String[] args) {
        ...
        LinkedListNode<Integer > newHead=flattenUsingPrioirityQueue(head);
