...
public class CountOfMinNumberOfDeletionsInAStringToMakeItPalindrome {
    ...
    public static void main(String[] args) {
        ...
        int result = new CountOfMinNumberOfDeletionsInAStringToMakeItPalindrome().LCS_top_down_approach(x,y,m,n);
