...
class TTGameBoard {
    ...
    char[][] board;
    int boardSize;
    Queue<Player1> nextTurn;
    Scanner input;

    public TTGameBoard(int boardSize, Player1[] players) {
    ...
    private int getUserInput(Player1 p){
        printBoard();
    ...
    private boolean checkEndGame(Player1 p, int row, int col){
        String winString = "";
...
public class TicTacToeNXN {
    ...
    public static void main(String[] args) {
        ...
        Player1[] players = new Player1[]{p1,p2};
        TTGameBoard gb = new TTGameBoard(3,players);
        gb.startGame();
    }
}
*/