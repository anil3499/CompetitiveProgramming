...
class SnakeAndLadderService {
    ...
    private Queue<Player1> players; // Comment: Keeping players in game service as they are specific to this game and not the board. Keeping pieces in the board instead.
    ...
    public SnakeAndLadderService(int boardSize) {
        ...
        this.players = new LinkedList<Player1>();
    ...
    public void setPlayers(List<Player1> players) {
        this.players = new LinkedList<Player1>();
    ...
    private void movePlayer(Player1 player, int positions) {
    ...
    private boolean hasPlayerWon(Player1 player) {
    ...
    public void startGame() {
        while (!isGameCompleted()) {
            ...
            Player1 currentPlayer = players.poll();
...
public class PlaySnakeAndLadder {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < noOfPlayers; i++) {
            players.add(new Player1(scanner.next()));
        }
